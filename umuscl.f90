     ...
     do j = jlo, jhi
        do i = ilo, ihi
           do l = 1, ngrid
              ...
              ! Set flagged cells riemann problem to llf
              iriemannFlag=iriemann ; Ptoto=0.d0
              ...
              ! Check for low beta in left state
              pmag = half*(qleft(4)*qleft(4)+qleft(6)*qleft(6)+qleft(8)*qleft(8))
              !if (qleft(2)/pmag<1.d-3) iriemannFlag=illf
              ...
              ! Check for low beta in left state
              pmag = half*(qright(4)*qright(4)+qright(6)*qright(6)+qright(8)*qright(8))
              !if (qright(2)/pmag<1.d-3) iriemannFlag=illf
              ...
              if (cartesian) then
                 ...
                 if ((Omega0>0.d0).and.(xdim==2).and..not.(fargo)) then
                    ...
                    if (shear>0.d0) then
                       ...
                       !Ekin = half*(qleft(3)**2+qleft(5)**2+qleft(7)**2) ! density missing ?
                       Ekin = half*qleft(1)*(qleft(3)**2+qleft(5)**2+qleft(7)**2) ! density added !
                       Etot = Ekin + Emag + qleft(2)/(gamma-1.d0)
                       fgdnv(1) = fgdnv(1) + shear*qleft(1)
                       !fgdnv(2) = fgdnv(2) + shear*(Etot+Emag-bn_mean**2)! only Etot ?
                       fgdnv(2) = fgdnv(2) + shear*Etot
                       ...
                       !Ekin = half*(qright(3)**2+qright(5)**2+qright(7)**2) ! density missing ?
                       Ekin = half*qright(1)*(qright(3)**2+qright(5)**2+qright(7)**2) ! density added !
