...
! calculate flux vector sizes
  ...
  if (restart>0) then
      ndump=restart
      call restart_run(uin,x,y,z,time,dt,dx,dy,dz,ndump,nhist,nspec,mype,cool_const,kappa)
  endif
...
subroutine read_input
  ...
  namelist /model_params/geom,xmin,xmax,ymin,ymax,zmin,zmax,gamma,Omega0,ciso,nu,eta,kappa
  namelist /output_params/dthist,dtdump,dtspec
