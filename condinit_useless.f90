module stratified
  ...
  logical :: floor,smooth,addmass,massDiff,stratif,resist
...
#include "mpif.h"
...
#endif
  !
  namelist /init_params/d0,beta,gamma,amp,n,type,dirname,floor,zfloor,dfloor,smooth,addmass,massDiff,stratif,rho_cool, c2_cool, t_cool,kappa,resist,IsoRestart
  !
  ...
  type='l'
  dirname=''
  floor=.false. ; smooth=.false. ; addmass=.false. ; massDiff=.false. ; stratif = .true.; resist=.false.
  zfloor=5.
